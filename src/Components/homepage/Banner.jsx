...
const Banner = () => {
    return (
        <div className={`container mx-auto p-10 bg-cover bg-center text-center lg:py-30 space-y-5 rounded-2xl mt-10`} style={{backgroundImage: `url(${summerSalePhoto.src})`}}>
